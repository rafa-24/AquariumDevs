<template>
  <section class="w-full py-16 px-4 md:px-8 bg-white">
    ...
    <div class="max-w-5xl mx-auto text-center mb-16">
      ...
      <p
        class="text-lg md:text-xl text-[#003543] max-w-4xl mx-auto leading-relaxed"
      >
        Los miembros del equipo del Acuario trabajan desde Chicago, Miami,
        Barranquilla, San Francisco, Nueva York, Bogotá, Washington, D.C., y
        muchos otros lugares repartidos por todo el mundo.
      </p>
    </div>
    ...
    <div class="max-w-6xl mx-auto">
      <div
        class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-2 md:gap-12"
      >
        <!-- Barranquilla -->
        <div
            ...
            >
              <g fill="none" transform="translate(1 1)">
                ...
                >
                  ...
                  />
                  <path
                    d="m22.9239443 5.03386892 10.103769-4.3227407 9.7556851 4.3227407"
                  />
                </g>
                <path
          ...
          <div class="w-24 h-24 mb-4 flex items-center justify-center">
            ...
            >
              <g fill="none" transform="translate(1.405405 .459459)">
                ...
                <path
                  d="m16.5025338 33.4081435v-29.90835465h2.6694468v29.90835465"
                  fill="#0bd8a2"
                />
                <path
                  d="m50.9349662 33.4081435v-29.90835465h2.6694468v29.90835465"
                  fill="#0bd8a2"
                />
                <g stroke="#00343d" stroke-width="1.621622">
                  ...
                  <g stroke-linecap="round" stroke-linejoin="round">
                    <path
                      d="m15.4594595 37.9938154v-4.5151755h4.7511349v3.9059095"
                    />
                    <path d="m17.838287 3.450918v-2.559666" />
                    <path
                      d="m49.8918919 37.9938154v-4.5151755h4.7511349v5.1854022"
                    />
                    <path
                      d="m16.5025338 33.4081435v-29.90835465h2.6694468v29.90835465"
                    />
